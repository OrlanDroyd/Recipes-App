package com.gmail.orlandroyd.foody.presentation.details.ingredients
...
import com.gmail.orlandroyd.foody.databinding.IngredientsRowLayoutBinding
import com.gmail.orlandroyd.foody.presentation.recipes.RecipesDiffUtil
import com.gmail.orlandroyd.foody.util.Constants.Companion.BASE_IMAGE_URL
import java.util.*

class IngredientsAdapter : RecyclerView.Adapter<IngredientsAdapter.MyViewHolder>() {

    private var ingredientsList = emptyList<ExtendedIngredientDto>()
    ...
    fun setData(newIngredients: List<ExtendedIngredientDto>) {
